...
[![Build Status](https://github.com/Monkestation/Monkestation2.0/actions/workflows/ci_suite.yml/badge.svg)](https://github.com/Monkestation/Monkestation2.0/actions/workflows/ci_suite.yml)
...
* **Code:** https://github.com/Monkestation/Monkestation2.0
* **Wiki:** https://tgstation13.org/wiki/Main_Page
* **Codedocs:** https://codedocs.tgstation13.org/
* **Monkestation Discord:** https://discord.gg/monkestation
* **Coderbus Discord:** https://discord.gg/Vh8TJp9

This is the codebase for the Monkestation flavoured fork of SpaceStation 13, a downstream of /tg/station.
...
**The long way**. Find `bin/build.cmd` in this folder, and double click it to initiate the build. It consists of multiple steps and might take around 1-5 minutes to compile. If it closes, it means it has finished its job. You can then [setup the server](.github/guides/RUNNING_A_SERVER.md) normally by opening `monkestation.dmb` in DreamDaemon.
