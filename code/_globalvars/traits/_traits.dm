...
GLOBAL_LIST_INIT(traits_by_type, list(
	...
	/mob = list(
		...
		"TRAIT_DISORIENTED" = TRAIT_DISORIENTED, //Monkestation Addition: stamina changes
		...
		"TRAIT_EXHAUSTED" = TRAIT_EXHAUSTED, //Monkestation Addition: stamina changes
		...
		"TRAIT_SPRINTING" = TRAIT_SPRINTING, //Monkestation Addition: stamina changes
		...
		"TRAIT_FUR_COLORS" = TRAIT_FUR_COLORS, //Monkestation Addition
	...
	/obj/item = list(
		...
		"TRAIT_NO_SPRINT" = TRAIT_NO_SPRINT, //Monkestation Addition: stamina changes
