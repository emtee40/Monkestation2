...
/datum/disease/advance
	...
	var/faltered = FALSE //Monkestation edit #186 //used if a disease has been made non-contagious
...
/datum/disease/advance/Copy()
	...
	A.id = id
	A.mutable = mutable
	A.faltered = faltered //Monkestation edit #186
	A.oldres = oldres
...
/datum/disease/advance/proc/assign_properties()
	...
	if(properties?.len)
		...
		if(faltered) //Monkestation edit #186
			spread_flags = DISEASE_SPREAD_FALTERED //Monkestation edit #186
			spread_text = "Intentional Injection" //Monkestation edit #186
		else if(properties["transmittable"] >= 11) //Monkestation edit #186
