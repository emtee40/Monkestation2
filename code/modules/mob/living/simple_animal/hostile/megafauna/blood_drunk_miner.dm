...
/mob/living/simple_animal/hostile/megafauna/blood_drunk_miner
	...
	pixel_x = -16
	base_pixel_x = -16
	crusher_loot = list(/obj/structure/closet/crate/necropolis/bdm/crusher) // monkestation change
	loot = list(/obj/structure/closet/crate/necropolis/bdm) // monkestation change
	wander = FALSE
	del_on_death = TRUE
