...
/mob/living/simple_animal/hostile/megafauna/hierophant
	...
	loot = list(/obj/structure/closet/crate/necropolis/hierophant) // monkestation change
	crusher_loot = list(/obj/structure/closet/crate/necropolis/hierophant/crusher) // monkestation change
	wander = FALSE
