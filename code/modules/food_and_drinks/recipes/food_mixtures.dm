...
/datum/chemical_reaction/food/grounding_neutralise
	...
	required_reagents = list(/datum/reagent/consumable/liquidelectricity = 2, /datum/reagent/consumable/grounding_solution = 1)	//Monkestation Edit: we don't have enriched liquid electricity
