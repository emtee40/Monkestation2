...
/datum/gas_reaction/fusion/react(datum/gas_mixture/air, datum/holder)
	...
	if(reaction_energy)
		if(location)
			...
			radiation_pulse(location, rand(6,30), 5, 60, 0 SECONDS, rad_power, 1) // Nonmodular. Fixes fusion going wacko mode - makes it significantly harder to irradiate people through walls, and fixes the range issue.
		var/new_heat_capacity = air.heat_capacity()
