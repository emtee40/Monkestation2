...
/datum/reagent/consumable/nutriment/feed_interaction(mob/living/basic/chicken/target, volume)	//Monkestation Addition: Chicken stuff
	. = ..()
...
/datum/reagent/consumable/sugar/feed_interaction(mob/living/basic/chicken/target, volume)	//Monkestation Addition: Chicken Stuff
	.=..()
...
/datum/reagent/consumable/entpoly/on_mob_life(mob/living/carbon/affected_mob, seconds_per_tick, times_fired)
	...
	if(SPT_PROB(10, seconds_per_tick))
		...
		affected_mob.stamina.adjust(-10*REM, FALSE)
...
/datum/reagent/consumable/liquidelectricity/on_mob_life(mob/living/carbon/affected_mob, seconds_per_tick, times_fired)	//Monkestation Edit: Removed enriched specificity
	. = ..()
