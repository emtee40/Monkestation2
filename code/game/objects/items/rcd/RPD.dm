...
//	custom_materials = list(/datum/material/iron=SHEET_MATERIAL_AMOUNT*37.5, /datum/material/glass=SHEET_MATERIAL_AMOUNT*18.75) // MONKESTATION EDIT CHANGE OLD // REQUIRES PR #75052
	custom_materials = list(/datum/material/iron=MINERAL_MATERIAL_AMOUNT*37.5, /datum/material/glass=MINERAL_MATERIAL_AMOUNT*18.75) // MONKESTATION EDIT CHANGE NEW
...
//	icon = 'icons/obj/assemblies/module.dmi' // MONKESTATION EDIT CHANGE OLD // REQUIRES PR #76788
