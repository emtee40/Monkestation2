...
GLOBAL_LIST_INIT(cloth_recipes, list ( \
	...
	new/datum/stack_recipe("satchel", /obj/item/storage/backpack/satchel, 4, check_density = FALSE, category = CAT_CONTAINERS), /*MONKESTATION ADDITION: Add a cloth recipe for satchels.*/ \
	null, \
