...
#define AUGMENT_NT_HIGHLEVEL list(SECURITY_PROTOCOL = list(SECURITY_NT2 , SECURITY_NT1), ENCODE_PROTOCOL = list(ENCODE_ENC2, ENCODE_ENC1), OPERATING_PROTOCOL = list(OPERATING_NTOS))
#define AUGMENT_TG_LEVEL list(SECURITY_PROTOCOL = list(SECURITY_NTX , SECURITY_NT2 , SECURITY_TMSP), ENCODE_PROTOCOL = list(ENCODE_TENN, ENCODE_ENC2, ENCODE_ENC1), OPERATING_PROTOCOL = list(OPERATING_TGMF, OPERATING_NTOS))
#define AUGMENT_SYNDICATE_LEVEL list(SECURITY_PROTOCOL = list(SECURITY_TOSP), ENCODE_PROTOCOL = list(ENCODE_CSEP , ENCODE_TENN, ENCODE_ENC2, ENCODE_ENC1), OPERATING_PROTOCOL = list(OPERATING_CSOF, OPERATING_NTOS))
