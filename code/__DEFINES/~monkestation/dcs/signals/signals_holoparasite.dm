...
/// Called after a holoparasite's stats are applied: (mob/living/basic/holoparasite/holopara)
#define COMSIG_HOLOPARA_STATS_APPLY					"holopara_stats_apply"

/// Called after a holoparasite's stats are removed: (mob/living/basic/holoparasite/holopara)
...
/// Called when a holoparasite enters scout mode
#define COMSIG_HOLOPARA_ENTER_SCOUT					"holopara_enter_scout"

/// Called when a holoparasite exits scout mode
#define COMSIG_HOLOPARA_EXIT_SCOUT					"holopara_exit_scout"

/// Called when a holoparasite enters cloak mode
#define COMSIG_HOLOPARA_ENTER_CLOAK					"holopara_enter_cloak"

/// Called when a holoparasite exits cloak mode
#define COMSIG_HOLOPARA_EXIT_CLOAK					"holopara_exit_cloak"
