...
/*#define JOB_BITRUNNER "Bitrunner" MONKESTATION REMOVAL: MERGED WITH PRISONERS*/
//Service
...
/*#define JOB_DISPLAY_ORDER_BITRUNNER 22 MONKESTATION REMOVAL: MERGED WITH PRISONERS*/
