...
#define CLONING_POD_TRAIT "cloning-pod"	//Monkestation Edit: We still have cloning... i think
...
#define NANITES_TRAIT "nanites"	// Monkestation Edit: Nanites
...
#define MADE_UNCLONEABLE "made-uncloneable"	//Monkestation Addition: We Re-added cloning
...
#define MECH_TRAIT "mech_trait"	// Monkestation Edit: Mech NVGs
