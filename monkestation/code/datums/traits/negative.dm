...
/datum/quirk/jailbird/post_add()
	...
	addtimer(CALLBACK(src, PROC_REF(apply_arrest), quirk_crime), 10 SECONDS) //Monkestation edit #186
...
/datum/quirk/stowaway/post_add()
	...
	addtimer(CALLBACK(src, PROC_REF(datacore_deletion)), 5 SECONDS) //Monkestation edit #186
