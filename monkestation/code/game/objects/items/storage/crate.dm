...
/obj/structure/closet/crate/necropolis/surplus/PopulateContents()
	...
	switch(loot)
		...
		if(94)
			new /obj/machinery/nuclearbomb/bee ///Monkestation addition, replaces /obj/item/clothing/under/misc/syndicate_souvenir(src) with /obj/machinery/nuclearbomb/bee(src)
		if(96)
