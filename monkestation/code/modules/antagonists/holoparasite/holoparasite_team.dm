...
/datum/team/holoparasites/New(starting_members, datum/holoparasite_holder/holder)
	...
	name = "Holoparasites of [holder.owner.name]"
...
/datum/team/holoparasites/roundend_report()
	...
	return {"
		<div class='panel [considered_alive(holder.owner) ? "green" : "red"]border'>
			<span class='header'>[holder.owner.name] had the following holoparasite[(length(holder.holoparasites) > 1) ? "s" : ""]:</span>
			<br>
			[print_all_holoparas()]
		</div>
	"}
...
/datum/team/holoparasites/proc/print_holopara(datum/mind/holopara_mind)
	var/mob/living/basic/holoparasite/holoparasite = holopara_mind?.current
...
/datum/team/holoparasites/proc/generate_section(mob/living/basic/holoparasite/holoparasite, title, icon, body, title_class = "")
...
/datum/team/holoparasites/proc/generate_stat_chart(mob/living/basic/holoparasite/holoparasite)
