/obj/item/melee/blood_magic/stun/afterattack(mob/living/target, mob/living/carbon/user, proximity)
	...
	else if(HAS_TRAIT(target, TRAIT_MINDSHIELD) || HAS_MIND_TRAIT(target, TRAIT_OCCULTIST) || cult.cult_team.cult_ascendent || cult.cult_team.is_sacrifice_target(target.mind))
...
/obj/item/melee/blood_magic/stun/proc/effect_weakened(mob/living/target, mob/living/carbon/user)
