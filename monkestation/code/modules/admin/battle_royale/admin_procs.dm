...
/datum/admins/proc/battle_royale_easy_setup()
	...
	var/input = tgui_alert(usr, "Do you want to quick start a battle royale?", "Battle royale", list("Normal(30 min max duration)", "Fast(10 min max duration)", "The lame option"))
