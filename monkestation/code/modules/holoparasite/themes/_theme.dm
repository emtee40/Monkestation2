...
/datum/holoparasite_theme/proc/apply(mob/living/basic/holoparasite/holoparasite)
...
/datum/holoparasite_theme/proc/create_overlays(mob/living/basic/holoparasite/holoparasite)
	return

/datum/holoparasite_theme/proc/display_message(mob/living/user, key, mob/living/basic/holoparasite/holoparasite)
