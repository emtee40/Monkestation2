...
/obj/projectile/holoparasite/on_hit(atom/target, blocked = FALSE, pierce_hit)
	...
	var/mob/living/basic/holoparasite/holopara = firer
	if(istype(holopara) && holopara.has_matching_summoner(target))
		...
		if(isholopara(target))
			var/mob/living/basic/holoparasite/other_holopara = target
 ...
 */
/mob/living/basic/holoparasite/bullet_act(obj/projectile/projectile)
 ...
 */
/mob/living/basic/holoparasite/proc/degrade_projectile(obj/projectile/projectile)
