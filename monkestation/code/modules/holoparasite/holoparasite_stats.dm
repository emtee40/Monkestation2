/datum/holoparasite_stats
	...
	var/mob/living/basic/holoparasite/last_holopara
...
/datum/holoparasite_stats/proc/apply(mob/living/basic/holoparasite/holopara)
...
/datum/holoparasite_stats/proc/remove(mob/living/basic/holoparasite/holopara)
	holopara = holopara || last_holopara
	if(!istype(holopara))
		return
	last_holopara = holopara
...
/datum/holoparasite_stats/proc/refresh(mob/living/basic/holoparasite/holopara)
	remove(holopara)
	apply(holopara)
