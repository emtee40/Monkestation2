 ...
 */
/mob/living/basic/holoparasite/proc/register_body_signals(mob/living/target)
 ...
 */
/mob/living/basic/holoparasite/proc/unregister_body_signals(mob/living/target)
 ...
 */
/mob/living/basic/holoparasite/proc/on_summoner_moved()
	SIGNAL_HANDLER
	setup_barriers()
 ...
 */
/mob/living/basic/holoparasite/proc/on_summoner_dir_change()
	SIGNAL_HANDLER
 ...
 */
/mob/living/basic/holoparasite/proc/on_summoner_update_health()
	SIGNAL_HANDLER
	update_health_hud()
	med_hud_set_health()
	med_hud_set_status()
