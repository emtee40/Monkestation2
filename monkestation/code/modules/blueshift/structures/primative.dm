...
GLOBAL_LIST_INIT(stone_recipes, list ( \
	new/datum/stack_recipe("stone brick wall", /turf/closed/wall/mineral/stone, 5,one_per_turf = TRUE, on_solid_ground = TRUE, category = CAT_STRUCTURE), \
	new/datum/stack_recipe("stone brick tile", /obj/item/stack/tile/mineral/stone, 1, 4, 20, category = CAT_TILES),
	new/datum/stack_recipe("millstone", /obj/structure/millstone, 6,one_per_turf = TRUE, on_solid_ground = TRUE, category = CAT_STRUCTURE),
	new/datum/stack_recipe("stone stove", /obj/machinery/primitive_stove, 5,one_per_turf = TRUE, on_solid_ground = TRUE, category = CAT_STRUCTURE),
	new/datum/stack_recipe("stone oven", /obj/machinery/oven/stone, 5,one_per_turf = TRUE, on_solid_ground = TRUE, category = CAT_STRUCTURE),
	new/datum/stack_recipe("stone griddle", /obj/machinery/griddle/stone, 5,one_per_turf = TRUE, on_solid_ground = TRUE, category = CAT_STRUCTURE),
	))
