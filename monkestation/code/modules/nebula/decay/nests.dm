...
/obj/structure/mob_spawner
	...
	icon = 'monkestation/code/modules/nebula/icons/nests.dmi'
	icon_state = "nest"
	density = FALSE
	anchored = TRUE
	layer = TABLE_LAYER
...
/obj/structure/mob_spawner/proc/spawn_mob()
	var/sound/sound_to_play = pick('monkestation/code/modules/nebula/sounds/rustle1.ogg', 'monkestation/code/modules/nebula/sounds/rustle2.ogg')
...
/obj/item/spider_egg
	...
	icon = 'monkestation/code/modules/nebula/icons/loot.dmi'
