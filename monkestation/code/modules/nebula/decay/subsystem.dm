...
#define FLOOR_BLOOD_PERCENT_CHANCE 10
#define FLOOR_VOMIT_PERCENT_CHANCE 10
#define FLOOR_OIL_PERCENT_CHANCE 5
#define FLOOR_COBWEB_PERCENT_CHANCE 3
...
SUBSYSTEM_DEF(decay)
	...
	var/list/station_filter = list("Runtime Station", "MultiZ Debug")
...
/datum/controller/subsystem/decay/proc/do_common()
	for(var/turf/open/floor/iterating_floor in possible_turfs)
		if(isopenspaceturf(iterating_floor))
			continue
