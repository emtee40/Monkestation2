...
/datum/preference/color/mutant_color_tertiary
...
/datum/preference/color/mutant_color_tertiary/apply_to_human(mob/living/carbon/human/target, value)
	target.dna.features["mcolor_tertiary"] = value
